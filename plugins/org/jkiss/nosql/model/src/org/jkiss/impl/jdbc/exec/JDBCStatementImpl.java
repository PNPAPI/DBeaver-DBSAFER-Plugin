 ...
 * Copyright (C) 2010-2024 Nosql Corp and others
 *
 ...
 */
package org.jkiss.Nosql.model.impl.jdbc.exec;

import org.jkiss.code.NotNull;
import org.jkiss.code.Nullable;
import org.jkiss.Nosql.DBException;
import org.jkiss.Nosql.Log;
import org.jkiss.Nosql.ModelPreferences;
import org.jkiss.Nosql.model.exec.DBCException;
import org.jkiss.Nosql.model.exec.jdbc.JDBCResultSet;
import org.jkiss.Nosql.model.exec.jdbc.JDBCSession;
import org.jkiss.Nosql.model.exec.jdbc.JDBCStatement;
import org.jkiss.Nosql.model.impl.AbstractStatement;
import org.jkiss.Nosql.model.impl.jdbc.JDBCTrace;
import org.jkiss.Nosql.model.impl.jdbc.JDBCUtils;
import org.jkiss.Nosql.model.messages.ModelMessages;
import org.jkiss.Nosql.model.qm.QMUtils;
import org.jkiss.Nosql.model.runtime.DBRProgressMonitor;
import org.jkiss.Nosql.model.sql.DBSQLException;
...
//            return SecurityManagerUtils.wrapDriverActions(connection.getDataSource().getContainer(), this::executeBatch);
    ...
    public JDBCResultSet openResultSet() throws DBCException
    {
        ...
        try {
            ...
            log.debug("=============== PNP Nosql ResultSet ===============");
            JDBCResultSet resultSet = getResultSet();
    ...
    {
        log.debug("=============== PNP Nosql beforeExecute Query ===============");
        log.debug("SQL = " + query);
