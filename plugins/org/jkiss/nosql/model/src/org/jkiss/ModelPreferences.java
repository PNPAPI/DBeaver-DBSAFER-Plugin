...
package org.jkiss.Nosql;

import org.jkiss.code.NotNull;
import org.jkiss.model.DBConstants;
import org.jkiss.model.connection.DBPConnectionConfiguration;
import org.jkiss.model.exec.DBCExecutionPurpose;
import org.jkiss.model.impl.preferences.BundlePreferenceStore;
import org.jkiss.model.preferences.DBPPreferenceStore;
import org.jkiss.model.qm.QMConstants;
import org.jkiss.model.qm.QMObjectType;
import org.jkiss.model.sql.SQLConstants;
import org.jkiss.model.virtual.DBVEntity;
import org.jkiss.registry.formatter.DataFormatterProfile;
...
public final class ModelPreferences
{
    ...
    public static final String PLUGIN_ID = "org.jkiss.model";
    ...
    public static final String PNP_SECURITY_CONNECT_USE = "pnp.security.connect.use"; //PNP-SECURITY-CONNECT-USE
    public static final String PNP_LOGIN_ID_STORE = "pnp.loginId"; //PNP-LOGIND-ID
    public static final String PNP_LOGIN_IP_ADDRESS = "pnp.loginIpAddress"; //PNP-LOGIND-IP-ADDRESS
    public static final String PNP_LOGIN_ASSSITKEY = "pnp.assistKey"; //PNP-ASSIST-KEY
    public static final String PNP_LOGIN_SECURITY_SERVER = "pnp.securty.server"; //PNP-SECURITY-SERVER
    ...
    private static void initializeDefaultPreferences(DBPPreferenceStore store) {
        ...
        PrefUtils.setDefaultPreferenceValue(store, UI_DRIVERS_SOURCES, "https://io/files/jdbc/");
        ...
        PrefUtils.setDefaultPreferenceValue(store, ModelPreferences.PNP_LOGIN_ID_STORE, "");
        PrefUtils.setDefaultPreferenceValue(store, ModelPreferences.PNP_LOGIN_IP_ADDRESS, "");
        PrefUtils.setDefaultPreferenceValue(store, ModelPreferences.PNP_LOGIN_ASSSITKEY, "");
        PrefUtils.setDefaultPreferenceValue(store, ModelPreferences.PNP_LOGIN_SECURITY_SERVER, "");
